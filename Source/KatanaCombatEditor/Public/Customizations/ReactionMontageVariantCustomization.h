...
/**
 * Property type customization for FReactionMontageVariant struct
 * Provides section dropdown populated from the selected montage
 * Used in the ReactionMontages array for per-variant section selection
 */
class FReactionMontageVariantCustomization : public IPropertyTypeCustomization
{
public:
