...
bool FKatanaSemanticGameplayTagsRegisteredTest::RunTest(const FString& Parameters)
{
	...
	TestTrue(TEXT("Attack.Defense.Parryable should be registered"),
		KatanaCombatGameplayTags::AttackDefenseParryable().IsValid());
	TestTrue(TEXT("Attack.Defense.BlockInterruptible should be registered"),
		KatanaCombatGameplayTags::AttackDefenseBlockInterruptible().IsValid());
