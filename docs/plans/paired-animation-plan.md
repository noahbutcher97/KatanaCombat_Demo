...
> **Last Updated**: 2026-02-02 | **Status**: Phase 5d ~95% COMPLETE - PT-1 through PT-9 IMPLEMENTED
...
| 2 | 5d-refactor | Preview Tool Architecture Refactor | ⏳ Optional cleanup |
...
| PT-20 | Deprecation debt (AnimNotifyState_AttackPhase) | P3 | ⏳ PENDING |
...
**PT-11: "God Widget" Anti-Pattern**
- **Issue**: `SPairedAnimationPreview` is 3000+ lines managing scene, viewport, UI, assets, events
- **Risk**: Difficult navigation, merge conflicts, tight coupling
- **Solution**: Extract to composition: `SPairedAnimationViewport`, `SPairedAnimationSettings`, `SPairedAnimationTimeline`
...
**PT-20: Deprecation Technical Debt**
- **Issue**: Support for deprecated `AnimNotifyState_AttackPhase` with no migration path
- **Solution**: Add `ensureMsgf` or "Fix It" button to actively push migration
